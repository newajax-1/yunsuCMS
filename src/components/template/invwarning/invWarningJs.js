    ...
    methods: {
        ...
        loadSearchSelect() {
            ...
            that.$ajaxWrap({
                ...
                callback(data) {
                    that.selectInvSts = data.data.dicData; 
                }
            })
        },
        //是否显示
            ...
            that.$ajaxWrap({
                ...
                callback(data) {
                    if(data.data.page.total == 0){
                        ...
                        that.tableData = data.data.page.list;
        ...
        toAdd() {
            ...
            that.$ajaxWrap({
                ...
                data : {} ,
                callback(data) {
                    that.selectOp = data.data.dicData;
                    that.selectItemOp = data.data.dataList;
                }
            });
        },
        ...
        edittab(ids){
            ...
            that.$ajaxWrap({
                ...
                callback(data) {
                    that.eselectOp = data.data.dicData;
                    that.eselectItemOp = data.data.dataList;
                    that.editTable =  data.data.data;
        ...
        UpdateInvWarning(){
            ...
            that.$ajaxWrap({
                ...
                data : {
                    ...
                    curInv:$.trim(that.editTable.curInv),
                },
                callback(data) {
                    that.$message({
                        message: '更新成功！',
