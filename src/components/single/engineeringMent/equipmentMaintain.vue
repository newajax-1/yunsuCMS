	...
	<div class="equipment-maintain">
	    <el-row>
                ...
                <div class="content-search">
                    <el-form :inline="true" class="">
                        ...
                        <el-form-item label="保养周期：">
                            <el-input placeholder="输入保养周期" v-model.trim="search_info.maint_cycle"></el-input>
                        </el-form-item>
                        <el-form-item>
            ...
            <el-col :span="24" class="content-buttons">
                ...
                <el-button v-if="buttonsRightList[2]" @click="toAdd()" class="btn btn-blue btn-large"><i class="fa fa-file-text-o"></i> 新建计划</el-button>
            </el-col>
