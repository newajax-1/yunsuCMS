        ...
        <el-row>
            ...
            <div class="content-buttons fl">
                <el-col :span="24">
                    ...
                    <el-button class="btn btn-blue" @click="toAdd()"><i class="fa fa-user-plus"></i> 新建预警</el-button>
                </el-col>
            </div>
            ...
            <el-col :span="24">
                <!-- 原料库存  成品库存  选择开始start -->
                <el-tabs v-model="active_name" type="card" class="list-tab" @tab-click="changeTableEffective">
