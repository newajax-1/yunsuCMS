	    ...
	    <el-row>
            ...
            <el-col :span="24">
                ...
                <div class="table-wrap">
                    ...
                    <!--分页 start-->
                    <div class="table-page" v-if="first_table_show && !second_table_text_show && (page_list.total === 0 ? false : true)">
                        <el-pagination
                ...
                <div class="table-wrap">
                    ...
                    <!--分页 start-->
                    <div class="table-page" v-if="second_table_show && !second_table_text_show && (page_list.total === 0 ? false : true)">
                        <el-pagination
                                @size-change="handleSizeChange"
                                @current-change="handleCurrentChange"
                                :current-page.sync="page_list.page_num"
                ...
                <div class="table-wrap">
                    <el-table 
                        ...
                        <el-table-column prop="comment" label="终止原因"></el-table-column>
                        <el-table-column prop="operUserName" label="下发人"></el-table-column>
                    </el-table>
                    <!--分页 start-->
                    <div class="table-page" v-if="other_table_show && !second_table_text_show && (page_list.total === 0 ? false : true)">
                        <el-pagination
                                @size-change="handleSizeChange"
                                @current-change="handleCurrentChange"
                                :current-page.sync="page_list.page_num"
