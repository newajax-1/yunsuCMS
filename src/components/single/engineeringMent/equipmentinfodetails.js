export default {
    ...
    created() {
        ...
        this.sale_change_type = this.$route.query.sale_change_type;
        this.table_is_show = (this.$route.query.whole_eqp_typ == "01" ? true : false)
        this.init();
    },
    data() {
        return {
    ...
    methods: {
        ...
        goBack(){
            this.$goRoute('/home/equipmentinfo', {
                whole_eqp_typ : this.whole_eqp_typ,
