                            ...
                            <el-row :gutter="24">
                                <el-col :span="12">
                                    <el-form-item label="安全库存：">
                                        <el-input placeholder="请输入安全库存" class="asterisk" v-model="add_info.secInv"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                    <el-form-item label="库存预警：低于">
                                        <el-input placeholder="请输入库存预警" class="asterisk" v-model="add_info.invAlarm"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form>
