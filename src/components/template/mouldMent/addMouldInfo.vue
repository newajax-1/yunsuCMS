                    ...
                    <el-row :gutter="24">
                        <el-col :span="6">
                            <el-form-item label="初始模数：">
                                <el-input placeholder="请输入初始模数" class="required" v-model="add_info.initCnt"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                    ...
                    <el-row :gutter="24">
                        <el-col :span="12">
                            <el-form-item label="模具制造：">
                                <el-input placeholder="请输入模具制造工厂" class="required width-other" v-model="add_info.mouldFactory"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row :gutter="24">
                        <el-col :span="24">
                            <el-form-item label="可用机台：" class="required">
                                <p class="machineName-text">{{ add_info.machine }}</p>
                            </el-form-item>
